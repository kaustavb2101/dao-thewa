...
export const THAI_RASI = [
  { id: 0, nameThai: 'ราศีเมษ', nameEn: 'Aries', symbol: '♈', animal: '🐏', startDeg: 0, element: 'Fire', ruler: 'MANGAL' },
  { id: 1, nameThai: 'ราศีพฤษภ', nameEn: 'Taurus', symbol: '♉', animal: '🐂', startDeg: 30, element: 'Earth', ruler: 'SHUKRA' },
  { id: 2, nameThai: 'ราศีเมถุน', nameEn: 'Gemini', symbol: '♊', animal: '🐅', startDeg: 60, element: 'Air', ruler: 'BUDHA' },
  { id: 3, nameThai: 'ราศีกรกฎ', nameEn: 'Cancer', symbol: '♋', animal: '🐇', startDeg: 90, element: 'Water', ruler: 'CHANDRA' },
  { id: 4, nameThai: 'ราศีสิงห์', nameEn: 'Leo', symbol: '♌', animal: '🐉', startDeg: 120, element: 'Fire', ruler: 'SURYA' },
  { id: 5, nameThai: 'ราศีกันย์', nameEn: 'Virgo', symbol: '♍', animal: '🐍', startDeg: 150, element: 'Earth', ruler: 'BUDHA' },
  { id: 6, nameThai: 'ราศีตุลย์', nameEn: 'Libra', symbol: '♎', animal: '🐴', startDeg: 180, element: 'Air', ruler: 'SHUKRA' },
  { id: 7, nameThai: 'ราศีพิจิก', nameEn: 'Scorpio', symbol: '♏', animal: '🐑', startDeg: 210, element: 'Water', ruler: 'MANGAL' },
  { id: 8, nameThai: 'ราศีธนู', nameEn: 'Sagittarius', symbol: '♐', animal: '🐒', startDeg: 240, element: 'Fire', ruler: 'GURU' },
  { id: 9, nameThai: 'ราศีมกร', nameEn: 'Capricorn', symbol: '♑', animal: '🐓', startDeg: 270, element: 'Earth', ruler: 'SHANI' },
  { id: 10, nameThai: 'ราศีกุมภ์', nameEn: 'Aquarius', symbol: '♒', animal: '🐕', startDeg: 300, element: 'Air', ruler: 'RAHU' },
  { id: 11, nameThai: 'ราศีมีน', nameEn: 'Pisces', symbol: '♓', animal: '🐖', startDeg: 330, element: 'Water', ruler: 'GURU' },
] as const;
