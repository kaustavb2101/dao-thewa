...
const C = StyleSheet.create({
  card: {
    alignItems: 'center', width: (width - 64) / 4, backgroundColor: Colors.bg.dark,
...
const S = StyleSheet.create({
  ...
  secTitle: {
    fontSize: 9, color: Colors.text.muted, letterSpacing: 1,
  ...
  planetPill: {
    alignItems: 'center', backgroundColor: Colors.bg.dark, borderRadius: 10,
